...
using System.IO;
using AdaptiveCards;
using FHL.Hack.SmartAssistantBot.Dialogs.Main.Resources;
    ...
    public class MainResponses : TemplateManager
    {
        private static LanguageTemplateDictionary _responseTemplates = new LanguageTemplateDictionary
        {
            ["default"] = new TemplateIdMap
            {
                ...
                { ResponseIds.BenefitsHelp, (context, data) => BuildHelpCard(context, data) },
                { ResponseIds.Intro, (context, data) => BuildIntroCard(context, data) },
                { ResponseIds.Tar, (context, data) => BuildIntroCard(context, data) },
                { ResponseIds.Benefits, (context, data) => BuildIntroCard(context, data) },
                { ResponseIds.Immigration, (context, data) => BuildIntroCard(context, data) },
            }
        };
        ...
        public class ResponseIds
        {
            ...
            public const string BenefitsHelp = "benefitsHelp";
